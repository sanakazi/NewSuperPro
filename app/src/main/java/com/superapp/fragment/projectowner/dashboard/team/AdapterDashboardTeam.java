...
public class AdapterDashboardTeam extends RecyclerView.Adapter<AdapterDashboardTeam.SingleItemRowHolder> {

    private ArrayList<Model> itemsList;
    private Context mContext;
    private static final String TAG= AdapterDashboardTeam.class.getSimpleName();
    ...
    public AdapterDashboardTeam(Context context, ArrayList<Model> itemsList ) {
    ...
    @Override
    public AdapterDashboardTeam.SingleItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.dashboard_client_item, null);
        AdapterDashboardTeam.SingleItemRowHolder mh = new AdapterDashboardTeam.SingleItemRowHolder(v);
        return mh;
    }

    @Override
    public void onBindViewHolder(AdapterDashboardTeam.SingleItemRowHolder holder, final int i) {
