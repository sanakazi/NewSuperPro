...
public class FragmentProjectDetailTeam extends BaseFragment {
    RecyclerView clients_recycler_view;
    ArrayList<Model> itemsList;
    AdapterProjectDetailTeam adapterProjectDetail;
    @Override
    ...
    {
        adapterProjectDetail = new AdapterProjectDetailTeam(getActivity(),itemsList);
        clients_recycler_view.setAdapter(adapterProjectDetail);
