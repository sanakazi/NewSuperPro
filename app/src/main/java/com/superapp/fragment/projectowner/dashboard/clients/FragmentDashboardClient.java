...
public class FragmentDashboardClient extends BaseFragment {
    RecyclerView clients_recycler_view;
    ArrayList<Model> itemsList;
    AdapterDashboardClient adapterDashboardClient;
    @Override
    ...
    {
        adapterDashboardClient = new AdapterDashboardClient(getActivity(),itemsList);
        clients_recycler_view.setAdapter(adapterDashboardClient);
