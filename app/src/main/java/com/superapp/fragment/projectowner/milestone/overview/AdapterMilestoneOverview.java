...
public class AdapterMilestoneOverview extends RecyclerView.Adapter<AdapterMilestoneOverview.SingleItemRowHolder> {
    ...
    private static final String TAG = AdapterMilestoneOverview.class.getSimpleName();
    ...
    public AdapterMilestoneOverview(Context context, ArrayList<Model> itemsList) {
    ...
    @Override
    public AdapterMilestoneOverview.SingleItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {

        if (viewType == TYPE_ITEM) {

        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.milestone_overview_item, null);
        AdapterMilestoneOverview.SingleItemRowHolder vhItem = new AdapterMilestoneOverview.SingleItemRowHolder(v,viewType);
        return vhItem;}
        else if (viewType == TYPE_HEADER) {

            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.milestone_overview_header_item, null);
    ...
    @Override
    public void onBindViewHolder(AdapterMilestoneOverview.SingleItemRowHolder holder, final int i) {
