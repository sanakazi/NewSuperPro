...
public class ActivityForgotPassword extends BaseAppCompatActivity/* implements ViewMain*/ {
    ...
    EditText username;
    Button send;
    TextInputLayout textinputforgot;
    @Override
    ...
    private void  initView()
    {
        ...
        send=findViewById(R.id.forgetpass);
        textinputforgot=findViewById(R.id.textinputforgot);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(getResources().getString(R.string.forgetpass));
    ...
    private boolean validateFields()
    {
        if (TextUtils.isEmpty(username.getText().toString().trim())) {
            textinputforgot.setError(getResources().getString(R.string.forgotpassvalidation));
            textinputforgot.requestFocus();
            return false;
        } else {
            textinputforgot.setError(null);
        }
...
//                submitOtp();
                Intent intent=new Intent(ActivityForgotPassword.this,ActivityVerification.class);
   ...
   /* private ImageView iv_back;
    ...
    private boolean validateFields() {
        ...
        if (TextUtils.isEmpty(et_username.getText().toString().trim())) {
            et_username.setError("requiredMobileNo");
            et_username.requestFocus();
            return false;
        } else {
            et_username.setError(null);
